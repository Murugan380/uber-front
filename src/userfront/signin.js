...
function Sign(){
    ...
    return(
        ...
        (<><div className="signup-page ma">
            <div className="signup-container">
            <form method="POST">
                <input type="text" placeholder="Name" className="form-control mb-3" name="name" onChange={(e)=>{setvalue(e);setEmail("");setConpass("");}} required></input>
